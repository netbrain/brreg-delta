...
// ProcessInParallelWithProgress processes items in parallel with a worker pool and shows total progress
func ProcessInParallelWithProgress(items []string, workers int, total int, fn func(string) error) error {
	if workers <= 0 {
		workers = 1
	}
